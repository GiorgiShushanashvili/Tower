...
public static class GlobalVariables
{
    ...
    public static float _regeneration;
    public static float _regenerationInterval;
    public static float _damageResistance;

    public static int _waveBonus;
    public static int _killBonus;
}
